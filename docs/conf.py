...
project = "S2WAV"
copyright = "2023, Matthew Price, Jason McEwen, Jessica Whitney, Alicja Polanska"
...
html_theme_options = {
    ...
    "navbar_align": "left",
    "announcement": "s2wav is currently in an open beta, please provide feedback on GitHub",
    "show_toc_level": 2,
    "show_nav_level": 1,
    ...
    "icon_links": [
        ...
        {
            "name": "CodeCov",
            "url": "https://app.codecov.io/gh/astro-informatics/s2wav",
...
latex_documents = [
    (
        ...
        "S2WAV.tex",
        "S2WAV Documentation",
        "Matthew Price, Jason McEwen, Jessica Whitney, Alicja Polanska",
        "manual",
    ),
]
...
man_pages = [(master_doc, "S2WAV", "S2WAV Documentation", [author], 1)]
